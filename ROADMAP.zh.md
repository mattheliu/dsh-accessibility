...
- 真人证据账本：`dsh-a11y-human-evidence/0.1.0-draft` 已定义公开 JSON Schema、隐私／时效／声明 validator、非证据模板以及本地／CI 门禁。它会保留失败和部分结果，同时对过期、私密、存在协助、不安全、无效或不完整的支持声明 fail-closed。账本尚无真实运行记录，因此当前证明的是治理已就绪，而不是 AT 或残障用户支持。
