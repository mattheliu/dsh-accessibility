...
- Area: <!-- core / companion / testkit / AT lab / authoring / docs and governance -->
- Tracking issue or proposal:
- User barrier or outcome:

## Change

Describe the behavior, the product boundary that owns it, and any compatibility or rollback implications.

## Validation

- [ ] Typecheck, tests, build, and package checks pass where applicable.
...
- [ ] The change does not add conversation/workspace access, network transfer, telemetry, recording, or persistence; or the new access is explained and has a privacy review.
- [ ] Public fixtures, logs, screenshots, and evidence contain no credentials, private prompts, conversations, usernames, personal data, or sensitive paths.
- [ ] The change does not repair host semantics/focus/keyboard behavior by observing generated classes or rewriting the DOM after render.
